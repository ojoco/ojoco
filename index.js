...
function createSessionId(credsPath) {
  ...
  // Simple format: DARKPATH-MD;;;[pure Base64]
  return `DARKPATH-MD;;;${base64Creds}`
}
    ...
    if (connection === 'open') {
      ...
      try {
        ...
        const caption = 
          ...
          ' 🔐 *DARKPATH MD SESSION ID* 🪪\n' +
 
     
          ' ✅ *Verified ,Active And Working!*\n' +       
        
          '> *_☠️☠️DARK PATH MD ☠️☠️_*\n' +
          '> *_Secure , Protected _*'
...
app.listen(PORT, () => {
  console.log(`🚀 DARK PATH MD Pairing Site LIVE -> http://localhost:${PORT}`)
